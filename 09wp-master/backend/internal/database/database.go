...
func ensureRequiredColumns() error {
	...
	requiredCols := []struct {
		...
		{"system_configs", "douban_cover_proxy_url", "ALTER TABLE system_configs ADD COLUMN douban_cover_proxy_url varchar(500) NOT NULL DEFAULT ''"},
		{"system_configs", "douban_search_cache_ttl", "ALTER TABLE system_configs ADD COLUMN douban_search_cache_ttl int NOT NULL DEFAULT 0"},
		{"system_configs", "tg_image_proxy_url", "ALTER TABLE system_configs ADD COLUMN tg_image_proxy_url varchar(500) NOT NULL DEFAULT ''"},
